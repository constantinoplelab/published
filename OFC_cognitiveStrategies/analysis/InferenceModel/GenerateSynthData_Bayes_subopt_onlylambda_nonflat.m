function [WTOpt, WTMdl, BlkInf, Belief, Kappa, Prior] =...
    GenerateSynthData_Bayes_subopt_onlylambda_nonflat(params, ratTrial,...
    noise_arg, gen_arg, noise_params)
%GenerateSynthData_Bayes_subopt_onlylambda_nonflat - generates synthetic 
% wait times for Bayes SubOpt model with lambda over a WEAKLY INFORMATIVE 
% PRIOR = [1/2 1/4 1/4].
% Inputs:
