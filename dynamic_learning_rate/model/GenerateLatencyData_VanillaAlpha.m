function [LatOpt, LatMdl, RPE, Kappa] =...
    GenerateLatencyData_VanillaAlpha(params, ratTrial,...
...
%   noise_params - the value of the noise variance. Use 1.5.
%% Pull Parameters
...
if gen_arg
    LatMdl = generate_wts(LatOpt, 10, noise_arg, noise_params);
else
    LatMdl = nan;
end
